...
![recyle-button](/imgs/posts/18/recycle-237874_1920.jpg)

씨네톡(영화 리뷰 서비스) 프로젝트에서는 반응형 디자인을 제공하기 때문에 다양한 크기의 버튼 디자인이 있습니다.

![guide1 !!500](/imgs/posts/18/guide1.png)
...
![guide1 !!900](/imgs/posts/18/guide3.png)
...
settings.json파일에 아래 코드를 추가하면 객체에 클래스를 입력할 때에도 Tailwind CSS IntelliSense가 적용됩니다.
